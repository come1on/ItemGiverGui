    ...
    if sort(player) then
      table.sort(matches, function(v1, v2)
        ...
        elseif sort2(player) then
          if proto[v1.name].group.name < proto[v2.name].group.name then
            return true
          elseif proto[v1.name].group.name == proto[v2.name].group.name then
            if proto[v1.name].subgroup.name < proto[v2.name].subgroup.name then
              return true
            elseif proto[v1.name].subgroup.name == proto[v2.name].subgroup.name then
              if v1.amount < v2.amount then
                return true
